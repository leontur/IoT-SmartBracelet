...
typedef TMilli smartBraceletC$Timer3$precision_tag;
typedef TMilli smartBraceletC$Timer1$precision_tag;
typedef TMilli smartBraceletC$Timer2$precision_tag;
...
static void smartBraceletC$Timer3$fired(void );
...
error_t error);
# 83 "/home/user/tinyos-main/tos/lib/timer/Timer.nc"
static void smartBraceletC$Timer1$fired(void );
# 75 "/home/user/tinyos-main/tos/interfaces/TaskBasic.nc"
...
# 83 "/home/user/tinyos-main/tos/lib/timer/Timer.nc"
static void smartBraceletC$Timer2$fired(void );
# 75 "/home/user/tinyos-main/tos/interfaces/TaskBasic.nc"
...
# 54 "/home/user/tinyos-main/tos/chips/atm128/pins/sim/HplAtm128GeneralIOPinP.nc"
...
# 64 "/home/user/tinyos-main/tos/lib/timer/Timer.nc"
static void smartBraceletC$Timer3$startPeriodic(uint32_t dt);
#line 78
static void smartBraceletC$Timer3$stop(void );
...
# 64 "/home/user/tinyos-main/tos/lib/timer/Timer.nc"
static void smartBraceletC$Timer1$startPeriodic(uint32_t dt);
#line 78
static void smartBraceletC$Timer1$stop(void );
# 67 "/home/user/tinyos-main/tos/interfaces/TaskBasic.nc"
...
message_t * msg);
# 64 "/home/user/tinyos-main/tos/lib/timer/Timer.nc"
static void smartBraceletC$Timer2$startPeriodic(uint32_t dt);
# 67 "/home/user/tinyos-main/tos/interfaces/TaskBasic.nc"
...
#line 135
static inline void smartBraceletC$Timer1$fired(void );





static inline void smartBraceletC$Timer2$fired(void );
...
static inline void smartBraceletC$Timer3$fired(void );
#line 162
...
# 64 "/home/user/tinyos-main/tos/lib/timer/Timer.nc"
inline static void smartBraceletC$Timer3$startPeriodic(uint32_t dt){
#line 64
...
inline static void smartBraceletC$Timer3$stop(void ){
#line 78
...
#line 83
# 64 "/home/user/tinyos-main/tos/lib/timer/Timer.nc"
inline static void smartBraceletC$Timer2$startPeriodic(uint32_t dt){
#line 64
...
#line 64
#line 78
inline static void smartBraceletC$Timer1$stop(void ){
#line 78
...
#line 374
{
  ...
  if (__nesc_ntoh_uint8(pairing_ack_dat->type.nxdata) == 1) {
      ...
      if (__nesc_ntoh_uint8(pairing_ack_dat->acknowledgement.nxdata) == 1) {
          ...
          smartBraceletC$Timer1$stop();


          if (smartBraceletC$isParent[sim_node()]) {


              smartBraceletC$Timer3$startPeriodic(60000);
            }
          else {


              smartBraceletC$Timer2$startPeriodic(10000);
            }
        }
    }
...
# 78 "/home/user/tinyos-main/tos/interfaces/Receive.nc"
inline static message_t * TossimActiveMessageC$Receive$receive(am_id_t arg_0x408926d8, message_t * msg, void * payload, uint8_t len){
#line 78
...
#line 78
    default:
#line 78
      __nesc_result = TossimActiveMessageC$Receive$default$receive(arg_0x408926d8, msg, payload, len);
#line 78
      break;
#line 78
    }
...
# 60 "/home/user/tinyos-main/tos/chips/atm128/pins/sim/HplAtm128GeneralIOPinP.nc"
static __inline void /*HplAtm128GeneralIOC.PortA.Bit0*/HplAtm128GeneralIOPinP$0$IO$toggle(void )
#line 60
{
#line 60
...
# 78 "/home/user/tinyos-main/tos/interfaces/Receive.nc"
inline static message_t * TossimActiveMessageC$Snoop$receive(am_id_t arg_0x40892d30, message_t * msg, void * payload, uint8_t len){
#line 78
  nx_struct message_t *__nesc_result;
#line 78

#line 78
    __nesc_result = TossimActiveMessageC$Snoop$default$receive(arg_0x40892d30, msg, payload, len);
#line 78
...
#line 104
# 64 "/home/user/tinyos-main/tos/lib/timer/Timer.nc"
inline static void smartBraceletC$Timer1$startPeriodic(uint32_t dt){
#line 64
...
{
  if (error == SUCCESS) {
      sim_log_debug(153U, "radioTX", "[info] Starting Timer1 (every %i ms) for broadcast pairing at %s \n", 15000, sim_time_string());
      smartBraceletC$Timer1$startPeriodic(15000);
    }
  else {
...
# 100 "/home/user/tinyos-main/tos/interfaces/Send.nc"
inline static void /*AMQueueP.AMQueueImplP*/AMQueueImplP$0$Send$sendDone(uint8_t arg_0x40a188d8, message_t * msg, error_t error){
#line 100
  switch (arg_0x40a188d8) {
#line 100
    case 0U:
#line 100
...
#line 100
    default:
#line 100
      /*AMQueueP.AMQueueImplP*/AMQueueImplP$0$Send$default$sendDone(arg_0x40a188d8, msg, error);
#line 100
      break;
#line 100
    }
...
#line 135
{
  sim_log_debug(155U, "radioTX", "[info] Timer1 fired at %s \n", sim_time_string());
...
#line 141
{
  sim_log_debug(156U, "radioTX", "[info] Timer2 fired at %s \n", sim_time_string());
...
#line 149
{
  sim_log_debug(157U, "radioTX", "[info] Timer3 fired at %s (missing messages from child in last %i ms) \n", sim_time_string(), 60000);
  smartBraceletC$Leds$led0Off();
  smartBraceletC$Leds$led1Off();
...
# 83 "/home/user/tinyos-main/tos/lib/timer/Timer.nc"
inline static void /*HilTimerMilliC.VirtualizeTimerC*/VirtualizeTimerC$0$Timer$fired(uint8_t arg_0x40b97644){
#line 83
  switch (arg_0x40b97644) {
#line 83
    case 0U:
#line 83
      smartBraceletC$Timer1$fired();
#line 83
      break;
#line 83
    case 1U:
#line 83
      smartBraceletC$Timer2$fired();
#line 83
      break;
#line 83
    case 2U:
#line 83
      smartBraceletC$Timer3$fired();
#line 83
      break;
#line 83
    default:
#line 83
      /*HilTimerMilliC.VirtualizeTimerC*/VirtualizeTimerC$0$Timer$default$fired(arg_0x40b97644);
#line 83
      break;
#line 83
    }
...
#line 67
# 80 "/home/user/tinyos-main/tos/interfaces/AMSend.nc"
inline static error_t /*AMQueueP.AMQueueImplP*/AMQueueImplP$0$AMSend$send(am_id_t arg_0x40a17294, am_addr_t addr, message_t * msg, uint8_t len){
#line 80
  unsigned char __nesc_result;
#line 80

#line 80
  __nesc_result = TossimActiveMessageC$AMSend$send(arg_0x40a17294, addr, msg, len);
#line 80
